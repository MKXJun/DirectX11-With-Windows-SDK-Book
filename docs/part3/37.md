...
![](E:\Code\Book\DirectX11-With-Windows-SDK-Book\docs\assets\37\01.png)
...
\begin{aligned}
[x,y,z,1]\begin{bmatrix}
s_w\cdot m_{00} & 0 & 0 & 0 \\
0 & s_h\cdot m_{11} & 0 & 0 \\
t_x & t_y & m_{22} & 1 \\
0 & 0 & m_{32} & 0 \\
\end{bmatrix}&=[s_w(m_{00}x)+t_x z,\; s_h(m_{11}y)+t_y z,\;m_{22}z+m_{32},\;z]\\
&\Rightarrow[\frac{s_w(m_{00}x)}{z}+t_x\;,\frac{s_h(m_{11}y)}{z}+t_y\;,m_{22}+\frac{m_{32}}{z}\;, 1]
\end{aligned}\\
$$
...
![](E:\Code\Book\DirectX11-With-Windows-SDK-Book\docs\assets\37\02.png)
...
![](E:\Code\Book\DirectX11-With-Windows-SDK-Book\docs\assets\37\03.png)
...
![](E:\Code\Book\DirectX11-With-Windows-SDK-Book\docs\assets\37\04.png)
...
![](E:\Code\Book\DirectX11-With-Windows-SDK-Book\docs\assets\37\05.png)


下图展示了需要进行逐样本着色的区域（红色边缘区域）：

![](E:\Code\Book\DirectX11-With-Windows-SDK-Book\docs\assets\37\06.png)
